...
void Adjust_Speed(void)
{
	...
	SetSpeed = (ADC_UserValue>>4)/8 + MIN_SPEED;
	...
	MC_ProgramSpeedRampMotor1(SetSpeed/6,100);
...
void exe(void)
{
	...
	MC_ProgramSpeedRampMotor1(1200/6,3000);
		...
		//Èý½Ç²¨
		HAL_Delay(3000);
		MC_ProgramSpeedRampMotor1(800/6,3000);
		HAL_Delay(3000);
		Run_Count++;
